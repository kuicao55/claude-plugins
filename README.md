...
| ----------- | ----------- | ----------- |
| `super-harness` | `kuicao-plugins` | Structured development workflow with pre-flight checks, Orchestrator/Executor/Reviewer architecture, cross-session milestone tracking, activity logging, TDD process enforcement, and dual-engine Codex integration (v3.2.4) — [repo](https://github.com/kuicao55/super-harness) |
